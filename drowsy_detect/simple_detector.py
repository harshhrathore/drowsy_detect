...
class SimpleDrowsinessDetector:
    ...
    def estimate_mouth_state(self, face_roi):
        ...
        if mouth_region.size > 0:
            ...
            # More lenient thresholds for yawn detection
            variance_threshold = 400  # Reduced from 800
            intensity_threshold = 120  # Increased from 100 (more lenient)
    ...
    def detect_drowsiness(self, frame):
        ...
        for (x, y, w, h) in faces:
            ...
            if self.eye_closed_counter >= self.eye_closed_threshold:
                ...
                drowsy_detected = True
                status_text = f"DROWSINESS DETECTED {mouth_open_seconds:.1f}s!"
                status_color = (0, 0, 255)  # Red
